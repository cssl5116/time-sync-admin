...
<template>
  <div class="role">
    ...
    <PageContent ref="contentRef" :content-config="contentConfig" @newly="handelAddEvent" @edit="handelEditEvent">
    </PageContent>
    <PageDialog :other-info="otherInfo" :dialog-config="dialogConfig" ref="dialogRef">
      <template #menus>
        <el-tree ref="treeRef" :data="userStore.menus" show-checkbox node-key="id" highlight-current
